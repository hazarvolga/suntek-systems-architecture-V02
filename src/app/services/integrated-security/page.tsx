                    ...
                    <div className="flex items-start justify-between gap-8">
                        <div>
                            <div className="flex items-center gap-4 mb-4">
                                <span className="text-primary font-mono text-xs border border-primary/30 px-2 py-1">SRV_05</span>
                            </div>
                            ...
                            <p className="text-silver text-lg font-light max-w-2xl leading-relaxed">
                                Converging physical and digital security through AI-powered CCTV, biometric access control, and centralized command centers.
                            </p>
                        </div>
                        <Video className="hidden lg:block size-24 text-primary/20 stroke-1" />
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                        ...
                        <div>
                            ...
                            <ul className="grid gap-4">
                                {[
                                    ...
                                    "Biometric Access Control (Finger/Face/Iris)",
                    ...
                    <div className="space-y-6">
                        <div className="p-8 border border-primary/30 bg-primary/5 rounded-xl">
                            <h4 className="text-primary font-bold text-sm tracking-widest uppercase mb-4">Integration</h4>
                            <div className="space-y-6">
                                <div>
                                    <p className="text-3xl font-bold text-off-white font-mono">Unified</p>
                                    <p className="text-xs text-silver/60">Single Pane of Glass</p>
                                </div>
                            </div>
                        </div>
                    </div>
