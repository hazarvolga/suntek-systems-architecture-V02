...
export default function TopBar() {
    ...
    return (
        <div className="hidden md:flex h-10 bg-black border-b border-grid-line items-center justify-between px-6 text-xs font-mono tracking-wide text-silver/60 z-[60] relative">
            {/* Left: Contact Info */}
